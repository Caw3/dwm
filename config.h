/* See L`ICENSE file for copyright and license details. */
...
static const char *colors[][3]      = {
	...
	[SchemeSel]  = { col_purple, col_gray4,  col_cyan  },
};
...
#define TAGKEYS(KEY,TAG) \
	{ STARTKEY,                       KEY,      view,           {.ui = 1 << TAG} }, \
	{ STARTKEY|ControlMask,           KEY,      toggleview,     {.ui = 1 << TAG} }, \
	{ STARTKEY|ShiftMask,             KEY,      tag,            {.ui = 1 << TAG} }, \
	{ STARTKEY|ControlMask|ShiftMask, KEY,      toggletag,      {.ui = 1 << TAG} },
